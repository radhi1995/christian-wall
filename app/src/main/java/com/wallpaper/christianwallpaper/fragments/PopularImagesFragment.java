...
import com.wallpaper.christianwallpaper.databinding.FragmentPopularImagesBinding;
...
public class PopularImagesFragment extends Fragment {
    private FragmentPopularImagesBinding _binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        _binding = FragmentPopularImagesBinding.inflate(inflater, container, false);
        return _binding.getRoot();
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        _imageItemModelLinkedList = _apiDataManger.getLoadedPopularItems();
    ...
    private void loadMoreData() {
        ...
        new Handler().postDelayed(() -> {
            ...
            LinkedList<ImageItemModel> imageItemModelLinkedList =_apiDataManger.getNextPopularData();
            _imageItemModelLinkedList.addAll(imageItemModelLinkedList);
            showOrHideViewOnDataSize();

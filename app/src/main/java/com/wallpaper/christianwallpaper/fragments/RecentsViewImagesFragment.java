...
import com.wallpaper.christianwallpaper.databinding.FragmentRecentViewImagesBinding;
...
public class RecentsViewImagesFragment extends Fragment {
    private FragmentRecentViewImagesBinding _binding;
    ...
    public RecentsViewImagesFragment() {
        // Required empty public constructor
    }

    public static RecentsViewImagesFragment newInstance() {
        RecentsViewImagesFragment fragment = new RecentsViewImagesFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        _binding = FragmentRecentViewImagesBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        _databaseRepository.getAllRecentViewImages().observe(getViewLifecycleOwner(), new Observer<List<RecentImage>>() {
            @Override
            public void onChanged(List<RecentImage> recentImages) {
                ...
                for (int i = 0; i < recentImages.size(); i++) {
                    ...
                    String imageWithPath = wallRawDirectory + recentImages.get(i).image_id;

...
final class BitmapHelper {
    ...
    static float sizeTrimmableLeft(Bitmap b) {
    ...
    static float sizeTrimmableRight(Bitmap b) {
    ...
    static float sizeTrimmableTop(Bitmap b) {
        for (int y = 0; y < b.getHeight() - 1; y++) {
            for (int x = 0; x < b.getWidth() - 1; x++)
    ...
    static float sizeTrimmableBottom(Bitmap b) {
    ...
    static Bitmap doTrim(Bitmap b, int trimLeft, int trimRight, int trimTop, int trimBottom) {
    ...
    static Bitmap doRotate(Bitmap b, float angle) {
    ...
    static Bitmap doScale(Bitmap b, float scale) {
        Matrix matrix = new Matrix();
